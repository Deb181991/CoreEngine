@manifestInScanDeliveryBranch
Feature: Verify  manifest In Scan at Delivery Branch
    ...
    Scenario Outline:  Verify  manifest In Scan at Delivery Hub
        ...
        And Click on Manifest In Scan Delivery Branch
        ...
        Examples:
            ...
            | santosh@esspl.com | Test@123 | data.xlsx | dummy     | 2     | 5        | Manifest In Scan completed at Delivery Branch | 2      | 18        |