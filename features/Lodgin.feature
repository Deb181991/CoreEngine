...
Feature: Create a new shipment and calculate charges
    ...
    Scenario Outline: Verify create shipment for business user
        ...
        Examples:
            ...
            | ABCD             | chinu         | Malaysia | 81600       | Selangor | Subang Jaya | 50            | BBSR    | Kampung Simon | abc123@gmail.com | 943951168 | Package       | Pickup  | ST00000003(General Express)| 1        | 10     | Standard Package | 5     | 5      | 5      | 21.84  | profile_pic.png | Order Placed | data.xlsx | dummy      | 2      | 5         |
    ...
    #         | ABCD             | chinu         | Malaysia | 55555       | Selangor | Subang Jaya | 50            | BBSR    | Cheras   | abc123@gmail.com | 943951168 | SERID1711(service new )   |  Package      | Lodge In / Walk In | 1        | 10     | Standard Package | 5    | 5      | 5      | 13.80  | profile_pic.png | Affin bank | Order Placed | data.xlsx | dummy    | 2     | 7        |
